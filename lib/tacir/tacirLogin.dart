...
import 'package:mooapp/tacir/tacirSignUp.dart';
import 'package:mooapp/src/Widget/bezierContainer.dart';

class tacirLogin extends StatefulWidget {
  tacirLogin({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _tacirLoginState createState() => _tacirLoginState();
}

class _tacirLoginState extends State<tacirLogin> {
  ...
  Widget _submitButton() {
    return InkWell(
        ...
        onTap: () {
          _authService
              .checkTacSign(_emailController.text, _passwordController.text,context);
        });
  }
  ...
  Widget _createAccountLabel() {
    return InkWell(
      onTap: () {
        Navigator.push(
            context, MaterialPageRoute(builder: (context) => tacirSignUp()));
      },
      child: Container(
            ...
            InkWell(
              ...
              onTap: () {
                Navigator.push(context,
                    MaterialPageRoute(builder: (context) => tacirSignUp()));
              },
            ),
          ],
        ),
